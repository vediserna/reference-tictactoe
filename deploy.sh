...
scp -i ~/my-ec2-key-pair-vediserna.pem .env ec2-user@ec2-54-191-32-51.us-west-2.compute.amazonaws.com:~/.

echo "Copying docker-compose.yml to aws"
scp -i ~/my-ec2-key-pair-vediserna.pem docker-compose.yml ec2-user@ec2-54-191-32-51.us-west-2.compute.amazonaws.com:~/.
